...
import { CreditCard, Calculator, Receipt, CheckCircle, ShieldCheck } from "@phosphor-icons/react";
...
export default function TariffsPage() {
  ...
  const totalPriceKzt = Math.round(leaseMonths * monthlyRateKzt * discountMultiplier);
  ...
  const handleGetInvoice = () => {
    toast.success(`Generated official KZT Invoice for ${leaseMonths} months (${totalPriceKzt.toLocaleString()} KZT). Check Payment History!`);
  };
      ...
      <div className="space-y-6">
        ...
        <div className="bg-surface border border-border p-5 rounded-2xl shadow-xs">
          ...
          <p className="text-xs text-secondary">
            Manage active storage limits, calculate lease extensions in Tenge (KZT), and review payment execution histories.
          </p>
        </div>

        {/* Tariff Information Header Card */}
        ...
        {/* Tariff Settings & Lease Extension */}
        <div className="bg-surface border border-border rounded-2xl p-6 shadow-sm">
          <div className="flex items-center gap-3 pb-4 border-b border-border mb-5">
